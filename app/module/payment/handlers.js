 ...
 * List
 *
 * @summary Test Payment api is working or not
 * @desc Route:
  <ol>
    <li>/api/Payment/test/{id}</li>
  </ol>
...
exports.test = async function (request, replay) {
    try {
        ...
        let count = await DataService.count("Payment", "payment_id", fields, {});
        let lastnumber = await DataService.lastentry("Payment", "payment_id", fields, {});
...
exports.list = async function (request, replay) {
    try {
        ...
        let data = await DataService.findModel("Payment",
            condition, fields, {});
...
exports.create = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Payment",{},'first_name last_name employee_id',{});
        let dataAdded = await DataService.create("Payment", "payment_id", request.payload, {});
...
exports.delete = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Payment",{},'first_name last_name employee_id',{});
        let dataDeleted = await DataService.delete("Payment", { 'payment_id': request.params.id }, {});
...
exports.patch = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Payment",{},'first_name last_name employee_id',{});
        let dataUpdated = await DataService.patch("Payment", { "payment_id": request.params.id }, request.payload, {});
