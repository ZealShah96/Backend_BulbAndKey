 ...
 * List
 *
 * @summary Test Gallery api is working or not
 * @desc Route:
  <ol>
    <li>/api/Gallery/test/{id}</li>
  </ol>
...
exports.test = async function (request, replay) {
    try {
        ...
        let count = await DataService.count("Gallery", "gallery", fields, {});
        let lastnumber = await DataService.lastentry("Gallery", "gallery", fields, {});
...
exports.list = async function (request, replay) {
    try {
        ...
        let data = await DataService.findModel("Gallery",
            condition, fields, {});
...
exports.create = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Gallery",{},'first_name last_name employee_id',{});
        let dataAdded = await DataService.create("Gallery", "gallery", request.payload, {});
...
exports.delete = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Gallery",{},'first_name last_name employee_id',{});
        let dataDeleted = await DataService.delete("Gallery", { 'gallery': request.params.id }, {});
 ...
 * update
 *
 * @summary patch Gallery details
 * @desc Route:
  <ol>
    <li>/api/Gallery/patch//{id}</li>
  </ol>
 * @param {Object} request - Request Object
 * @param {Object} reply - Reply Object
 */
exports.patch = async function (request, replay) {
    try {
        //   let data=await DataService.findModel("Gallery",{},'first_name last_name employee_id',{});
        let dataUpdated = await DataService.patch("Gallery", { "gallery": request.params.id }, request.payload, {});
